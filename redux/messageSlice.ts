...
export const selectAllMessages = (state: { messages: MessageState }) => state.messages.messages;
export const selectLoading = (state: { messages: MessageState }) => state.messages.loading;
export const selectLoaded = (state: { messages: MessageState }) => state.messages.loaded;