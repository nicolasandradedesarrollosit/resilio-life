            ...
            <ModalBody className="flex flex-col items-center">
              ...
              >
                <div className="w-4/5 space-y-2 relative">
                  ...
                  <span
                    aria-live="polite"
                    className={`text-xs absolute left-0 ${validations.title ? "visible text-red-400" : "invisible"}`}
                    role="alert"
                  >
                    {validations.title}
                  </span>
                ...
                <div className="w-4/5 space-y-2 relative">
                  ...
                  <span
                    aria-live="polite"
                    className={`text-xs absolute left-0 ${validations.description ? "visible text-red-400" : "invisible"}`}
                    role="alert"
                  >
                ...
                <div className="w-4/5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2 relative">
                    ...
                    <span
                      aria-live="polite"
                      className={`text-xs absolute left-0 ${validations.pointsCost ? "visible text-red-400" : "invisible"}`}
                      role="alert"
                    >
                ...
                <div className="w-4/5 space-y-3">
                  ...
                  <span
                    aria-live="polite"
                    className={`text-xs block ${validations.image ? "visible text-red-400" : "invisible"}`}
                    role="alert"
                  >
                    {validations.image}
                  </span>
